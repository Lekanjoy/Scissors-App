...
const HeroPage = () => {
  return (
    <section className="relative  bg-heroBg  bg-no-repeat bg-cover bg-center  text-center flex flex-col justify-center items-center px-8 lg:px-[93px] lg:pt-[106px]">
      ...
      <div className="mt-20 mb-[76px] flex flex-col justify-center items-center max-w-[505px] rounded-3xl text-center border-[0.5px] border-[#005AE2] bg-[rgba(254,_254,_254,_0.1)] lg:px-[60px] lg:py-10">
