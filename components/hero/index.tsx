...
const HeroPage = () => {
  return (
    <section
      id="hero"
      className="relative w-full bg-heroBg pt-[130px] bg-no-repeat bg-cover bg-center text-center flex flex-col justify-center items-center px-4 md:px-10 lg:px-[93px] lg:pt-[146px]"
    >
      <h1 className="text-blackVariant text-[24px] leading-[40px] mb-3 font-bold lg:text-5xl lg:leading-[96px]">
      ...
      <p className=" text-sm md:font-medium  lg:text-lg lg:max-w-[780px]">
